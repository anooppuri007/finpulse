...
/* ── Streamlit expander tweaks for dark theme ── */
...
/* Fix Streamlit default text colors in dark theme */
.stMarkdown p { color: #CBD5E0 !important; }
...
/* Hide Streamlit menu buttons on cards */
